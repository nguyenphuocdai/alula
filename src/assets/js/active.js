(function ($) {
    ...
    // $('body').delegate('#user-options','click',function(){
    ...
    //     $("#language-options")
    //       .siblings()
    //       .removeClass("active-dropdown-menu");
    //     $("#currency-options")
    //       .siblings()
    //       .removeClass("active-dropdown-menu");
    //   });
    ...
    =            slick slider active            =
    =============================================*/
    var $htSlickSlider = $('.ht-slick-slider--footer .ht-slick-slider');
    ...
    // $( "body" ).delegate( "#close-newsletter-popup", "click", function() {
